  ...
  return (
    <div onMouseEnter={playm} className={styles.cardBox}>
      ...
      <div className={styles.card}>
        ...
        <div
          className={`${props.git || props.fb || props.linkedin || props.portfolio ? styles.content : styles.blankContent}`}
        >
          <p className={styles.name}>{props.name}</p>
          {props.designation && <p className={styles.designation}>{props.designation}</p>}
        </div>
        {(props.git || props.fb || props.linkedin || props.portfolio) && (
              ...
              {props.portfolio && (
                <div className={styles.icon}>
                  <a href={props.portfolio} target="_blank" rel="noreferrer">
                    <FaGlobe className={`${styles.logo} ${styles.portfolioImg}`} />
                  </a>
                </div>
              )}
            </div>
